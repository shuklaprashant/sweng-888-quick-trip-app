...
import com.sweng888.quicktrip.adapter.PreferencesViewPagerAdapter;
...
public class PreferencesFragment extends Fragment {
    ...
    public static PreferencesFragment newInstance(String category) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ViewPager pager = view.findViewById(R.id.htab_viewpager);
    ...
    private void setupViewPager(ViewPager pager){
        PreferencesViewPagerAdapter adapter = new PreferencesViewPagerAdapter(this.getFragmentManager());
